...
" Enforce good habits with navigation
nnoremap <Left> :echoe "Use h instead of 'Left'"<CR>
nnoremap <Down> :echoe "Use j instead of 'Down'"<CR>
nnoremap <Up> :echoe "Use k instead of 'Up'"<CR>
